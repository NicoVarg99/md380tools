...
const static wchar_t wt_datef_iso8601[]     = L"DD-MM-YYYY";
...
void create_menu_entry_datef_screen(void) {
  ...
  create_menu_entry_hook( md380_menu_id + 4, wt_datef_iso8601,  create_menu_entry_datef_iso8601_screen + 1, md380_menu_entry_back+1, 0x8b, 0 , 1);
#endif
